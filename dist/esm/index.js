...
var BackgroundLocationPermissionErrorCode;
...
})(BackgroundLocationPermissionErrorCode || (BackgroundLocationPermissionErrorCode = {}));
 ...
 * }
 */
const BackgroundLocationPermission = registerPlugin('BackgroundLocationPermission', {
    web: () => Promise.resolve().then(function () { return web; }).then(m => new m.BackgroundLocationPermissionWeb()),
});

class BackgroundLocationPermissionWeb extends WebPlugin {
...
export { BackgroundLocationPermission, BackgroundLocationPermissionErrorCode };
